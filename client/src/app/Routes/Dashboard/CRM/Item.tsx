    ...
    return (
        ...
        <p>
          <strong>Published:</strong> {item.published}
                ...
                <button className=" mt-auto  hover:bg-hoverColor hover:text-main-purple border-1 shadow-sm  text-white bg-main-purple rounded-lg py-1" onClick={() => window.open(item.url, "_blank")}>
                    Read Now
                </button>
            </div>
        </>
